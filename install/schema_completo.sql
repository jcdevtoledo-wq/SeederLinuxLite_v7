...
CREATE TABLE IF NOT EXISTS users (
    ...
    organization_id INTEGER,  -- nullable, for operador_om role
...
CREATE TABLE IF NOT EXISTS organizations (
    ...
    description TEXT,
    is_active BOOLEAN DEFAULT TRUE,
    serial_config INTEGER DEFAULT 1,  -- incremented when config changes
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Add foreign key constraint separately (organizations must exist first)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Purpose: Store generated bundles for download later
-- ============================================================================
...
-- ============================================================================
-- Table: audit_events
-- Purpose: Structured audit trail with JSONB details
-- ============================================================================
...
-- ============================================================================
-- Table: stations
-- Purpose: Inventory of provisioned machines
-- ============================================================================
